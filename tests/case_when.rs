...
#[theory]
#[test]
#[case("case   a when 1 then '甲' when 2 then '乙' End", NSQL, "case a when 1 then '甲' when 2 then '乙' end")]
#[case("case a when 1 then '甲' when 2 then '乙' ELSE '其他' End", NSQL, "case a when 1 then '甲' when 2 then '乙' else '其他' end")]
